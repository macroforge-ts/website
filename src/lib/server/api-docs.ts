 ...
 */
export function getRustItems(
    crateName: string,
    itemNames: string[]
): Record<string, ApiItem | null> {
 ...
 */
export function getBuiltinMacros(
    macroNames: string[]
): Record<string, BuiltinMacroDoc | null> {
