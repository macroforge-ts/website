...
<ul>
	<li><a href="/docs/custom-macros/ts-macro-derive">Learn the ts_macro_derive attribute</a></li>
	<li><a href="/docs/custom-macros/ts-quote">Master the ts_quote template syntax</a></li>
</ul>
